      ...
      {finderUrl && (
        <div className="bg-primary-50 border border-primary-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-primary-600 mt-1">Official government polling station finder</p>
          </div>
        </div>
      )}
      ...
      {apiError ? (
        ...
        <>
          ...
          <div className="flex gap-2">
            <label htmlFor="polling-map-address" className="sr-only">Enter your address to find nearby polling stations</label>
            <input
