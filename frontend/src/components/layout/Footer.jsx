  ...
  return (
    <footer aria-label="Footer" className="bg-neutral-50 border-t border-neutral-200 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mt-8 pt-6 border-t border-neutral-200">
          <p className="text-xs text-neutral-500 text-center">
            © {new Date().getFullYear()} Electra. Content sourced from official government websites.
      ...
      <Modal
        ...
        id="feedback-modal"
      >
        <FeedbackForm country={country} onClose={() => setFeedbackOpen(false)} />
      </Modal>
    </footer>
  )
}
