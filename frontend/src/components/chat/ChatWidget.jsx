...
export default function ChatWidget() {
  ...
  async function handleSend() {
    ...
    try {
      ...
      setMessages((m) => [
        ...m,
        { role: 'assistant', text: 'Sorry, the chat service is temporarily unavailable. Please try again.' },
      ]);
    } finally {
      setLoading(false);
    }
    ...
    <>
      ...
      >
        {isOpen
          ...
          : <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"/></svg>
        }
      </button>
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-neutral-200">
            ...
            <button onClick={() => setIsOpen(false)} aria-label="Close chat" className="text-neutral-400 hover:text-neutral-700 focus:outline-2 focus:outline-primary-600 rounded p-0.5">
          ...
          <div className="p-3 border-t border-neutral-200 flex gap-2">
            ...
            />
            <Button variant="primary" size="sm" onClick={handleSend} loading={loading} ariaLabel="Send message">
              Send
            </Button>
          </div>
        </div>
