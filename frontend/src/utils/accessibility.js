 ...
 * @returns {Function} cleanup — Call this to remove the trap.
 */
 ...
 *
 * @param {{ current: HTMLElement }} modalRef   — React ref to the modal container.
 * @param {{ current: HTMLElement }} triggerRef — React ref to the element that opened the modal.
