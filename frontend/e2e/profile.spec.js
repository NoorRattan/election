...
async function injectFakeAuth(page) {
  ...
  await page.addInitScript(() => {
    ...
    const key =
      ...
      'firebase:authUser:test-key:[DEFAULT]'
...
test.describe('Profile page', () => {
  ...
  test('Progress list shows "voter-registration" as completed indicator', async ({ page }) => {
    const completed = page
      .getByText(/voter.registration/i)
      .or(page.getByText(/voter registration/i))
  ...
  test('Progress list shows "ballot-types" as not yet completed', async ({ page }) => {
    const incomplete = page.getByText(/ballot.types/i).or(page.getByText(/ballot types/i))
