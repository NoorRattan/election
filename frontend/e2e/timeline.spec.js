...
test.describe('Timeline page', () => {
  ...
  test('"Add to Calendar" button is present on upcoming events', async ({ page }) => {
    ...
    const calendarBtn = page
      .getByRole('button', { name: /add.*calendar/i })
      .or(page.getByRole('link', { name: /add.*calendar/i }))
  ...
  test('Clicking "Local" filter: local events visible, national events hidden', async ({
    page,
  }) => {
