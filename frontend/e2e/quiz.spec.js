...
const SUBMIT_FIXTURE = {
  ...
  results: [
    ...
    { question_id: 'q3', correct: true,  explanation: 'UK general elections are held every 5 years.' },
  ],
};
...
test.describe('Quiz page', () => {
  test('navigating to /quiz/voter-registration without auth redirects to /login', async ({ page }) => {
