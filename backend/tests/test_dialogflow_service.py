...
from app.services.dialogflow_service import query_dialogflow, _STATIC_FALLBACK_REPLY
...
async def test_query_dialogflow_success(mock_settings, mocker):
    ...
    mocker.patch("google.cloud.dialogflowcx_v3.services.sessions.SessionsClient", return_value=mock_sessions_client)
...
async def test_query_dialogflow_regional_location(mock_settings, mocker):
    ...
    mock_sessions_client_class = mocker.patch("google.cloud.dialogflowcx_v3.services.sessions.SessionsClient")
    ...
    mock_sessions_client_class.assert_called_with(client_options={"api_endpoint": "eu-dialogflow.googleapis.com"})
